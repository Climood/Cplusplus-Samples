========================================================================
    КОНСОЛЬНОЕ ПРИЛОЖЕНИЕ. Обзор проекта прописные в строчные с побитовым или
========================================================================

Это приложение прописные в строчные с побитовым или создано автоматически с помощью мастера приложений.

В этом файле представлена сводка содержимого всех файлов, входящих в состав приложения прописные в строчные с побитовым или.


прописные в строчные с побитовым или.vcxproj
...
прописные в строчные с побитовым или.vcxproj.filters
...
прописные в строчные с побитовым или.cpp
...
StdAfx.h, StdAfx.cpp
    Эти файлы используются для построения файла предкомпилированного заголовка (PCH) с именем прописные в строчные с побитовым или.pch и файла предкомпилированных типов с именем StdAfx.obj.
