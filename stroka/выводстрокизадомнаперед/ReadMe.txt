========================================================================
    КОНСОЛЬНОЕ ПРИЛОЖЕНИЕ. Обзор проекта выводстрокизадомнаперед
========================================================================

Это приложение выводстрокизадомнаперед создано автоматически с помощью мастера приложений.

В этом файле представлена сводка содержимого всех файлов, входящих в состав приложения выводстрокизадомнаперед.


выводстрокизадомнаперед.vcxproj
...
выводстрокизадомнаперед.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Эти файлы используются для построения файла предкомпилированного заголовка (PCH) с именем выводстрокизадомнаперед.pch и файла предкомпилированных типов с именем StdAfx.obj.
